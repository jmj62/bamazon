...
var appStart = function()
{
    ...
    .prompt([
    {
        ...
        choices:['[V]iew Products for Sale', 'View Low [I]nventory', '[A]dd to Inventory', '[A]dd New Product']
    }])
...
function addInventory()
{
    ...
    // New Table instance to format returned sql data
        var table = new Table(
        {
                head: ['ItemID', 'ProductName', 'Price', 'Quantity'], colWidths: [10, 40, 10, 10]
        });
